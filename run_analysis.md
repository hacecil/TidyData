run_analysis
============
Last updated 2016-09-05 17:47:52 using R version 3.3.0 (2016-05-03).
...
```
## [1] "C:/Users/Hank/Documents/GitHub/TidyData"
```
...
**See the `README.txt` file in C:/Users/Hank/Documents/GitHub/TidyData for detailed information on the dataset.**
...
Read the activity files. These are called *label* files in the `README.txt` documentation.
